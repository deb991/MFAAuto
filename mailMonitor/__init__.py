...
newsCredSubKWrdI = re.search(r'Lost', inboxMail.Subject) #used
newsCredSubKWrdJ = re.search(r'mfa$', inboxMail.Subject) #used
newsCredSubKWrdK = re.search(r'MFA Support', inboxMail.Subject) #Used
